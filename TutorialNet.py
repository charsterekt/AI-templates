...
# For larger deep neural networks
...
# Softmax function for classification/regression problems problems:
...
if __name__ == "__main__":
    ...
    # Using this method we can save the trained data into a file and reopen it later to skip training
    with open("saved_network.bin", "wb") as file:
        pickle.dump(net, file)
    del net  # deleting the old variable because we'll get it back when loading later

    # Loading
    with open("saved_network.bin", "rb") as file:
    ...
    while True:
        ...
        print("Probability distribution is: {}".format(stable_softmax(outputs)))
